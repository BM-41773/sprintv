  ...
  //  alert("aaauyuyyyy");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            console.log("ID: " + data[0].logginId + " name: " + data[0].NFFirstname + " picture: " + data[0].NFProfilepic + "pstcontent:" + data[0].headerposting + "pstimage:" + data[0].imgposting);
            ...
            var html = '<img src="' + data[0].NFProfilepic + '" style="height:35px; "/> <label style="margin-left:5px;">' + data[0].NFFirstname + '</label> <br><label>' + data[0].headerposting + ' <img src="' + data[0].imgposting + '" style="height:40px;" /><br/><hr>'
            $(".nws").append(html);
            $(".nws").show();
